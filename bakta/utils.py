...
def parse_arguments():
    ...
    arg_group_organism.add_argument('--organism', action='store', default=bc.ORGANISM_BACTERIA, choices=[bc.ORGANISM_BACTERIA, bc.ORGANISM_ARCHAEA], help='Organism domain profile: bacteria/archaea (default = bacteria)')
    ...
    arg_group_annotation.add_argument('--gram', action='store', default=bc.GRAM_UNKNOWN, choices=[bc.GRAM_POSITIVE, bc.GRAM_NEGATIVE, bc.GRAM_UNKNOWN], help=f'Gram type for signal peptide predictions: {bc.GRAM_POSITIVE}/{bc.GRAM_NEGATIVE}/{bc.GRAM_UNKNOWN} (default = {bc.GRAM_UNKNOWN}; ignored for --organism archaea)')
